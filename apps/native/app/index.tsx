...
const COMPONENTS: ComponentItem[] = [
...

  {
    ...
    component: function DropdownMenuExample() {
      const { colors } = useColorScheme();
      const [menu, setMenu] = React.useState<'primary' | 'destructive'>(
        'primary',
      );
    ...
    component: function RatingsIndicatorExample() {
      ...
      return (
        <View className="gap-3">
          <Text className="pb-2 text-center font-semibold">
          ...
          <View className="flex-row">
            ...
            <View className="flex-1">
              <Text variant="caption1" className="text-muted-foreground">
                Don't request a review when the user is doing something time
                sensitive.
              </Text>
            </View>
          </View>
          <View className="flex-row">
            ...
            <View className="flex-1">
              <Text variant="caption1" className="text-muted-foreground">
                Don't ask the user any questions before or while presenting the
                rating button or card.
              </Text>
            </View>
          </View>
        </View>
